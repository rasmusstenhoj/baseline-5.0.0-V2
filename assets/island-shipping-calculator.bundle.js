// _src/js/islands/shipping-calculator.js
import deferrableData from "deferrable-data";

// _src/js/components/shipping-calculator.js
var shipping_calculator_default = () => ({
  country: null,
  ...
  get provinces() {
    return this.selectedCountryOptionEl && this.selectedCountryOptionEl.hasAttribute("data-provinces") ? JSON.parse(this.selectedCountryOptionEl.dataset.provinces) : [];
  },
  init() {
...
// _src/js/islands/shipping-calculator.js
deferrableData("ShippingCalculator", shipping_calculator_default);
